...
export default function Navigation() {
  return (
    <div className='px-[1rem] md:px-[3rem] relative'>
          ...
          {/*1. Logo */}
          <div className='fixed  top-0 md:left-[6rem] z-[1500] '>
      ...
      {/* For responsive navigation */}
        ...
        {/* 1. Links */}
            ...
            <ul className="flex flex-col md:flex-row gap-20 mt-20 md:mt-0">
          ...
          {/* ------------------- */}
          <div className="fixed top-0 md:top-10 right-[7rem] flex gap-6 md:gap-10 items-end text-white">
                {/* 3. Localisation */}
